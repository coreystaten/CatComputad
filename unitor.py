...
unitor10 = PrimitiveFamily("unitor10", 1, [0], unitor10Source, unitor10Target)
...
unitor11 = PrimitiveFamily("unitor11", 1, [0], unitor11Source, unitor11Target)
...
unitor20Source = minimalASTFromEqMol1(fEqMol1(comp0(prim1ToMol1(unitor10.buildPrim([_a])),_b)), [_a,_b])
unitor20Target = minimalASTFromEqMol1(fEqMol1(prim1ToMol1(unitor10.buildPrim([comp0(_a, _b)]))), [_a,_b])
unitor20 = PrimitiveFamily("unitor20", 2, [0, 0], unitor20Source, unitor20Target)

#unitor21Paths1 = findPaths1(comp0s([_a, unit, _b]), comp0s([_a,_b]), [unitor10, unitor11])
unitor21Source = minimalASTFromEqMol1(fEqMol1(
    comp0(prim1ToMol1(unitor11.buildPrim([_a])), _b)), [_a, _b])
unitor21Target = minimalASTFromEqMol1(fEqMol1(
    comp0(_a, prim1ToMol1(unitor10.buildPrim([_b])))), [_a, _b])
unitor21 = PrimitiveFamily("unitor21", 2, [0, 0], unitor21Source, unitor21Target)

#unitor22Paths1 = findPaths1(comp0s([_a, _b, unit]), comp0s([_a, _b]), [unitor10, unitor11])
unitor22Source = minimalASTFromEqMol1(fEqMol1(
    prim1ToMol1(unitor11.buildPrim([comp0(_a, _b)]))), [_a, _b])
unitor22Target = minimalASTFromEqMol1(fEqMol1(
    comp0(_a, prim1ToMol1(unitor11.buildPrim([_b])))), [_a, _b])
unitor22 = PrimitiveFamily("unitor22", 2, [0, 0], unitor22Source, unitor22Target)
...
#unitor30Source1 = ensureEqMol1(comp0s([prim1ToMol1(unitor10.buildPrim([_a])), _b, _c]))
#unitor30Target1 = ensureEqMol1(unitor10.buildPrim([comp0s([_a, _b, _c])]))
#unitor30Paths2 = findPaths2(unitor30Source1, unitor30Target1, [unitor20])
unitor30Source = minimalASTFromEqAEMol2(ensureEqAEMol2(
    unitor20.buildPrim([_a, comp0(_b, _c)])), [_a, _b, _c])
unitor30Target = minimalASTFromEqAEMol2(ensureEqAEMol2(
    comp2(
        comp0(unitor20.buildPrim([_a, _b]), _c),
        unitor20.buildPrim([comp0(_a, _b), _c]))), [_a, _b, _c])
unitor30 = PrimitiveFamily("unitor30", 3, [0, 0, 0], unitor30Source, unitor30Target)
...
#unitor31Source1 = ensureEqMol1(comp0s([unitor11.buildPrim([_a]), _b, _c]))
#unitor31Target1 = ensureEqMol1(comp0(_a, unitor10.buildPrim([comp0(_b,_c)])))
...
unitor31Source = minimalASTFromEqAEMol2(ensureEqAEMol2(
    unitor21.buildPrim([_a, comp0(_b, _c)])), [_a, _b, _c])
unitor31Target = minimalASTFromEqAEMol2(ensureEqAEMol2(
    comp2(comp0(unitor21.buildPrim([_a,_b]), _c), comp0(_a, unitor20.buildPrim([_b, _c])))), [_a, _b, _c])
unitor31 = PrimitiveFamily("unitor31", 3, [0, 0, 0], unitor31Source, unitor31Target)
...
#unitor32Source1 = ensureEqMol1(comp0(unitor11.buildPrim([comp0(_a,_b)]), _c))
#unitor32Target1 = ensureEqMol1(comp0s([_a, _b, unitor10.buildPrim([_c])]))
...
unitor32Source = minimalASTFromEqAEMol2(ensureEqAEMol2(
    unitor21.buildPrim([comp0(_a,_b), _c])), [_a, _b, _c])
unitor32Target = minimalASTFromEqAEMol2(ensureEqAEMol2(
    comp2(
        comp0(unitor22.buildPrim([_a, _b]), _c),
        comp0(_a, unitor21.buildPrim([_b, _c]))
    )), [_a, _b, _c])
unitor32 = PrimitiveFamily("unitor32", 3, [0, 0, 0], unitor32Source, unitor32Target)
...
#unitor33Source1 = ensureEqMol1(unitor11.buildPrim([comp0s([_a, _b, _c])]))
#unitor33Target1 = ensureEqMol1(comp0s([_a, _b, unitor11.buildPrim([_c])]))
...
unitor33Source = minimalASTFromEqAEMol2(ensureEqAEMol2(
    unitor22.buildPrim([comp0(_a, _b), _c])), [_a, _b, _c])
unitor33Target = minimalASTFromEqAEMol2(ensureEqAEMol2(
    comp2(
        unitor22.buildPrim([_a, comp0(_b, _c)]),
        comp0(_a, unitor22.buildPrim([_b, _c])))), [_a, _b, _c])
unitor33 = PrimitiveFamily("unitor33", 3, [0,0,0], unitor33Source, unitor33Target)
