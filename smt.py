...
#searchForPathPairs3AdjFam(omega4Paths2, omega4Paths2, [omega3], [])
# SUCCESS!!!!!!
...
tensorShuf30Source2 = minimalASTFromEqAEMol2(ensureEqAEMol2(
    comp2s(
        ...
        comp1(
            ...
            u2.adj.fprimf([_H], _a, comp0(_b, _c))),
        comp1(
...
u3Source1 = ensureEqMol1(
    comp1s(
        ...
        shuffle1.fprim(_Ha, _Hb),
        chi1.fprimf([_H], _b, _a)
    )
)
u3Target1 = ensureEqMol1(
    comp1s(
        chi1.fprimf([_H], _a, _b),
        app(_H, shuffle1.fprim(_a, _b)),
        app(_H, shuffle1.fprim(_b, _a)),
        app(_H, shuffle1.fprim(_a, _b))
    )
)
u3Paths2 = findPaths2(u3Source1, u3Target1, [syllepsis2, u2.adj, appComp1, appComp1.adj])
